    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         DefaultTableModel model = (DefaultTableModel) table.getModel();
           try {
            ...
            Connection con = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock", "root", "Assier123");
...
//        int tot = Integer.parseInt(jTextField3.getText()) * Integer.parseInt(jTextField5.getText());
...
//    }
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
             ...
             Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock", "root", "Assier123");
             ...
             int success=0;
                        ...
                        // smt3.executeQuery(query); //updated
                        
             
                       success=smt3.executeUpdate(query); //updated
          ...
          public void workWithDatabase()
    {
        ...
        Connection c=null;
         Statement  s3 = null, s2 = null , s=null;
         ResultSet rs1=null;
         int flag=0;
         try{
             
        Class.forName("com.mysql.jdbc.Driver");
       c=DriverManager.getConnection("jdbc:mysql://localhost:3306/java_stock","root","Assier123");
       s=c.createStatement();
       s2=c.createStatement();
       s3=c.createStatement();
    //    String query = " Delete From purchase Where item_id =('" + jTextField1.getText()+ "')";

    //          s3.executeUpdate(query); //updated
    //          int success=s3.executeUpdate(query);
    //                         if(success==1)
    //                         {
  ...
  DefaultTableModel model = (DefaultTableModel) table.getModel();   
   ...
   // jLabel6.setText(s1);
             ...
             while(rs1.next()) {
                ...
                if(id>id2){
                    JOptionPane.showMessageDialog(this, "You do not have this much quantity to return", "Error!", JOptionPane.OK_OPTION );
                }
                else{
                 int id3=id2+id;
               s2.executeUpdate("Update inventory set quantity="+id3+" where item_id="+"'"+s1+"'");
            }
           }
         /*     while(rs1.next())
       {
    ...
    private void txtKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPasswordKeyPressed
