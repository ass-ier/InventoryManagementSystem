...
public class supplierapprove extends javax.swing.JFrame {
   ...
   /*   int success=stmt.executeUpdate(query);
     ...
     {
    sum=sum+Float.parseFloat(table2.getValueAt(i,4).toString()); //updated
     }
jLabel2.setText("" + sum);
...
this.setVisible(false);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
       workWithDatabase();
       JOptionPane.showMessageDialog(this, "Product successfully approved!");
        }catch(ArrayIndexOutOfBoundsException e){
            JOptionPane.showMessageDialog(this,"Select atleast one order to approve","Error",JOptionPane.OK_OPTION);//updated
        }
    }
   
        
     public void workWithDatabase() throws ArrayIndexOutOfBoundsException
    {
        Connection c=null;
         Statement  s2 = null , s =null;
         ResultSet rs1=null;
         int flag=0;
         try{
...
//    jLabel6.setText(s1);
             ...
             while(rs1.next()) {
                 ...
                 int id3=id2+id;
               s2.executeUpdate("Update inventory set quantity="+id3+" where item_id="+"'"+s1+"'"); //update
